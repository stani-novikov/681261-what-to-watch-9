  ...
  return (
    <div className="film-card__reviews film-card__row">
      <div className="film-card__reviews-col">
        <div className="review">
          <blockquote className="review__quote">
            <p className="review__text">Discerning travellers and Wes Anderson fans will luxuriate in the glorious
              Mittel-European kitsch of one of the director funniest and most exquisitely designed films in years.
            </p>
        ...
        <div className="review">
          <blockquote className="review__quote">
            <p className="review__text">Anderson films are too precious for some, but for those of us willing to lose
              ourselves in them, they are a delight. The Grand Budapest Hotel is no different, except that he has added
        ...
        <div className="review">
          <blockquote className="review__quote">
            <p className="review__text">I didnt find it amusing, and while I can appreciate the creativity, it is an
